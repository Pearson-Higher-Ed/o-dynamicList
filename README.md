...
1. Clone this repository into a new folder:
  ...
  ```
  git clone https://github.com/Pearson-Higher-Ed/o-dynamicList.git o-your-component
  ```
2. Search `o-dynamicList` and replace with `o-your-component`:

  ```
  find . -name '*.*' -type f -print -exec sed -i '' 's/o-dynamicList/o-your-component/g' {} \;
  ```
...
This is a fork of [Financial-Times/o-dynamicList](https://github.com/Financial-Times/o-dynamicList), which is published by the Financial Times under the [MIT license](http://opensource.org/licenses/MIT).
